      ...
      <div className="container mx-auto px-6">
        ...
        <section className="flex flex-col lg:flex-row items-center justify-between py-20 gap-16">
          <div className="lg:w-1/2 text-center lg:text-left space-y-8">
            <div className="inline-block px-4 py-1 bg-black/5 rounded-full text-black text-sm font-bold tracking-widest uppercase mb-4">
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 pt-4">
              <NavLink
                ...
                className="bg-black text-white px-10 py-5 rounded-2xl font-black text-lg flex items-center justify-center gap-3 hover:bg-gray-800 transition shadow-2xl active:scale-95"
              >
          ...
          <div className="lg:w-1/2 flex justify-center relative">
            ...
            <div className="bg-black text-white p-10 rounded-[3rem] w-full max-w-md shadow-[0_50px_100px_-20px_rgba(0,0,0,0.3)] transform hover:rotate-2 transition-transform duration-500">
              ...
              <p className="text-white/40 text-sm font-bold tracking-widest uppercase">Member Card</p>
              
              <div className="grid grid-cols-3 gap-6 mt-12 mb-16">
                <div className="text-center group">
                  <div className="w-12 h-12 bg-white/10 rounded-2xl flex items-center justify-center mx-auto mb-2 group-hover:bg-white group-hover:text-black transition-all">
        ...
        <section className="py-24 border-t border-gray-100">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            <div className="group">
              <div className="w-16 h-16 bg-gray-50 rounded-3xl flex items-center justify-center mb-8 group-hover:bg-black group-hover:text-white transition-all transform group-hover:rotate-6 shadow-sm">
                <FaUserCheck className="text-2xl" />
              </div>
              <h3 className="text-2xl font-black mb-4">Fast Check-in</h3>
            ...
            <div className="group">
              ...
              <h3 className="text-2xl font-black mb-4">Exclusive Perks</h3>
        ...
        <footer className="py-12 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center text-sm font-bold text-gray-400 gap-6">
          <p>© 2024 KROO LOYALTY DESIGNED BY ANTIGRAVITY</p>
          <div className="flex gap-8 uppercase tracking-[0.2em] text-[10px]">
            <NavLink className="hover:text-black transition-colors">Privacy</NavLink>
            <NavLink className="hover:text-black transition-colors">Terms</NavLink>
            <NavLink className="hover:text-black transition-colors">Support</NavLink>
          </div>
        </footer>
      </div>
    </div>
